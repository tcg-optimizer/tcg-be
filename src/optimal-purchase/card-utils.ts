import { getShippingInfo } from '../common/utils/shipping-info';

function getSellerId(seller: any): any {
...
function filterTopSellers(cardsList: any[], options: any): any[] {
  let topN = 30;
  ...
  return cardsList
    .map(card => {
      ...
      const groupedProducts = (Object.values(productsBySeller) as any[]).sort(
        (a, b) => a.price - b.price
      );
...
function isNaverStore(seller: any): boolean {
...
export { getSellerId, filterTopSellers, isNaverStore };
