function parseYugiohRarity(title) {
  const rarityPatterns = [
    {
      pattern: /(오버\s*프레임\s*레어|오버프레임레어|오버프레임|over\s*frame\s*rare|over\s*frame)/i,
      rarity: '오버 프레임 레어',
    },
    {
      pattern:
        /(그랜드\s*마스터\s*레어|그랜드마스터레어|그랜드마스터|grand\s*master\s*rare|grand\s*master|grandmaster\s*rare)/i,
      rarity: '그랜드 마스터 레어',
    },
    {
