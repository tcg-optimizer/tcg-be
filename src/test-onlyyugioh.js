...
async function testOnlyYugiohCrawling() {
  try {
    const cardName = '스프라이트엘프';
    console.log(`온리유희왕 크롤링 테스트 시작: "${cardName}"`);
    
    // 크롤링 테스트
    console.log('크롤링 시작...');
    const results = await crawlOnlyYugioh(cardName);
